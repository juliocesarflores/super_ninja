...
//pc JOEL SOPANTA QUISPE 

//construimos la pantalla del juego escenario
...
public class Escenario{
	...
	public Escenario(ManejadorPantalla pantalla){
		...
		frames = new ArrayList<FrameEscenario>(); ///FRAME del escenario
		x = 0;
		y = 0;
		ancho = 0;
	...
	public void actualizar(long tiempoTranscurrido,ManejadorPantalla pantalla,Jugador criatura) throws Exception{
        ...
        ///utilizamos programacion orientada a objetos
